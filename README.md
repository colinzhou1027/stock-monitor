...
> 自动推送韩股、美股、港股日报和月报到企业微信群，支持 AI 智能分析
...
| 📈 **月度趋势报告** | 每月初自动生成上月股价趋势图 + AI 分析 |
| 🤖 **AI 智能分析** | 基于近 3 天新闻分析股价涨跌原因 |
...
# AI 配置（可选，推荐配置以获得 AI 分析）
GEMINI_API_KEY=your-gemini-api-key    # 2026年5月30日前免费优先使用
QWEN_API_KEY=your-qwen-api-key        # 通义千问备用
...
| 提供商 | 模型 | 优先级 |
|--------|------|--------|
| Google Gemini | gemini-2.5-flash | 2026年5月30日前免费优先 |
| 通义千问 | qwen-max | 备用 |

AI 分析功能：
- **日报**：分析上一交易日股价涨跌原因（基于近 3 天新闻）
- **月报**：月度新闻汇总 + 月度走势分析
